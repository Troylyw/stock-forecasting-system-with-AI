...
def run_simulation_task(form_data_dict, results_container_arg, sse_q):
    ...
    try:
        ...
        config['DEEPSEEK_API_KEY'] = form_data_dict.get('deepseek_api_key', default_util.DEEPSEEK_API_KEY)
        config['MODEL_NAME'] = form_data_dict.get('model_name', "deepseek-reasoner")
